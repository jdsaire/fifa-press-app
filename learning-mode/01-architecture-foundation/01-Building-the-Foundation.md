...
This app has exactly one component built this way so far: `EventCard`, at [`../src/frontend/Components/EventCard.razor`](../../src/frontend/Components/EventCard.razor). It's worth understanding well, because everything else in this file builds on it.
...
On the page side, at [`EventList.razor:28`](../../src/frontend/Pages/EventList.razor), you'll see the shorthand this pattern unlocks:
