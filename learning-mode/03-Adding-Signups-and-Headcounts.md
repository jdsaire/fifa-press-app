...
**[`SessionTracker.cs`](../src/EventEase/Services/SessionTracker.cs)** answers *"which matches has this visitor requested access to?"* — a per-person question.

**[`AttendanceTracker.cs`](../src/EventEase/Services/AttendanceTracker.cs)** answers *"how many people, and who, have requested access to this specific match?"* — a per-match question, and one that would make sense to show to anyone looking at that match, not just the person who just submitted a request.
